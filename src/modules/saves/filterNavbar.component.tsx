...
import {
  InputWrapper, Navbar, NumberInput, SegmentedControl, Select, Switch,
} from '@mantine/core';
    ...
    >
      <Navbar.Section>
        <Select
          ...
          onWheel={(ev: React.WheelEvent) => setFilters(produce((draft) => { draft.creatureType = CREATURE_TYPES_WITH_ALL[(CREATURE_TYPES_WITH_ALL.indexOf(filters.creatureType) + (ev.deltaY > 0 ? 1 : -1))]; }))}
        />
        <NumberInput
          defaultValue={4}
