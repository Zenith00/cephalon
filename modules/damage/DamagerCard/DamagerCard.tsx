...
function DamagerCard({
  ...
  useEffect(() => {
    ...
    attackModParsed, attackModSelected, attackModOptions, disabled, playerKey,
    debouncedDispatchPlayerList, damager]);
        ...
        <MultiSelect
          ...
          onCreate={(query) => {
            if (!query.match(modRegex)) {
              ...
              setTimeout(() => { setAttackModError(false); setAttackModPlaceholder(''); }, 1500);
            }
          }}
